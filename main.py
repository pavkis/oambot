...
group_filters = {
    (-1002409298826): ["bread", "41 wallets", "‼️"],  #source test
    (7855397066): ["41 wallets"],  # Smart Money Ray
    (7957014661): ["‼️"],  # Ray Agate
}

# Stop-words for source groups
group_stopwords = {
    (-1002409298826): ["stopword", "stopword"],
}

# Dynamic target group mapping
group_config = {
    (-1002409298826): [4537474080, 4598894964],  #target test
    (7855397066): [5486942816],  # Smart Money Ray to Maestro
    (7957014661): [7753411011, 4598894964],  # Ray Agate to Nova, HUB
}
